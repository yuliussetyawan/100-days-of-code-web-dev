...
const higlightedParagraph = document.querySelector(".highlighted-paragraph");
console.dir(higlightedParagraph);

// 5. BONUS TASK: Try changing the text content of the <p> element
//    you selected in (4) and set it to any other text of your choic
higlightedParagraph.textContent = "Hello World";
